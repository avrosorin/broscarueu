...
export const buttonStyles = {
	primary:
		'min-h-6 rounded-xl flex items-center justify-center leading-loose bg-indigo-500/50 px-6 hover:bg-indigo-500/80 cursor-pointer text-indigo-200 hover:text-indigo-50'
};
